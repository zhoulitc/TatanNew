namespace Tatan.Data.DAO
{
    ...
    #region Permission的实体类，无法继承
    /// <summary>
    /// Permission的实体类，无法继承。此实体保存了用户以及登录信息
    /// </summary>
    [Serializable]
    public sealed class Permission : DataEntity
    {
        #region 构造函数
        /// <summary>
        /// 构造函数
        ...
        #region Table
        [NonSerialized]
        private static readonly Table _table = new PermissionTable();
        private class PermissionTable : Table
        {
